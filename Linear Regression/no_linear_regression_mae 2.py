...
if __name__ == "__main__":
    ...
    ax.legend(loc="best")
    plt.savefig("data parabola.png")

    # Initial guess of the parameters: [2, 2, 2] (a, b, c).
    # It doesn’t have to be accurate but simply reasonable.
    initial_guess = np.array([300, 200, -200])
    ...
    plt.savefig("mae_regression_2.png")
